...
export const CURRENT_RELEASE_ANNOUNCEMENT = Object.freeze({
  id:"2026-07-22-complete-creator-update",
  ...
  items:Object.freeze([
    ...
    Object.freeze({
      title:"论坛发帖、评论与阅读体验",
      body:"论坛主楼现在保留回车分段，并在帖子详情提供明确“编辑”按钮，可重改标题、正文、时间和图片。评论与楼中楼支持调整顺序、编辑显示时间和设置点赞数；读者端可按热门或最新排序并在本次阅读中点赞。论坛 IP 开关默认关闭，开启后只显示作者配置的属地，不会给读者本人伪造 IP。",
    }),
    Object.freeze({
      title:"多角色续答与 @ 提及",
      body:"消息、动态和论坛的读者回复选项可以配置多条作者续答，每条续答都能单独选择联系人主号、论坛小号或 NPC。群聊、发帖、评论、回复和编辑流程均可通过“@ 提及”选择身份；作品文件仍保存纯文本，作者预览和读者端负责识别与高亮。",
    }),
    Object.freeze({
      title:"占位符与跨作品写作习惯",
      body:"“新占位符”等显示名称现在可以直接修改；全文替换、随机替换和场景锁定继续保持作品内独立。常用占位符可以保存为作者全局习惯并单独导入导出，套用时只创建当前作品副本。写作习惯页还可用带版本号的联系人包在两篇作品之间合并人物，遇到 ID 冲突会保留两边。",
    }),
    Object.freeze({
      title:"内置教程与功能答疑",
