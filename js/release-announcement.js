...
export const CURRENT_RELEASE_ANNOUNCEMENT = Object.freeze({
  ...
  items:Object.freeze([
    ...
    Object.freeze({
      title:"论坛发帖、评论与阅读体验",
      body:"论坛主楼现在保留回车分段，并在帖子详情提供明确“编辑”按钮，可重改标题、正文、时间和图片。帖子可自定义显示评论总数，主评论也可单独填写显示楼层；留空时仍按实际评论数和顺序计算。评论与楼中楼支持调整顺序、编辑显示时间和设置点赞数；读者端可按热门或最新排序并在本次阅读中点赞。论坛 IP 开关默认关闭，开启后只显示作者配置的属地，不会给读者本人伪造 IP。",
    }),
    Object.freeze({
      title:"多角色续答与 @ 提及",
