  ...
  return `<div class="resource-panel" data-resource-panel="tutorial">
    ...
    ${tutorialGuide({
      ...
      steps:[
        ...
        { title:"建立联系人", body:"<p>在手机桌面点【联系人】App，再点底部【+ 添加联系人】。输入姓名并点【确定】；联系人会先以简洁卡片出现。点【编辑联系人资料】，再按需展开【身份与备注】【头像与通话】【读者添加】或【论坛身份】，最后点【保存】。</p>" },
        { title:"填写 App 内容", body:"<p>回到手机桌面，点要编辑的 App。消息写在【消息】里，帖子写在【论坛】里，备忘内容写在【备忘录】里。</p>" },
        { title:"设置角色内容", body:"<p>第一次点【消息】、【论坛】、【备忘录】、【相册】、【浏览器】或【购物】时，会打开角色接入页。选择联系人，再点【保存并编辑内容】。保存后再次进入会直接打开该角色内容；需要更换时点标题栏右上角【切换】。</p>" },
        { title:"添加读者回复选项", body:"<p>打开会话后，长按或右键目标消息，点【添加选项】。填写【选项文字】和【发送内容】；需要更多分支时点【添加新选项组】。编辑器一次只展开一组选项，图片、沉默、结束话题和默认节奏都在【图片与更多设置】中。</p>" },
        { title:"调整 App 位置", body:"<p>点手机上方【排列】，再点一个 App。使用方向按钮移动，也可以直接拖动。完成后点【完成】。</p>" },
        { title:"安排阅读顺序", body:"<p>回到手机桌面，点【设置】App，再切到【播放顺序】。打开【阅读节奏控制】开关，拖动内容卡片排序，最后点底部【保存】。</p>" },
      ...
      faq:[
        ...
        { title:"创建单聊或群聊", body:"<p>点桌面【消息】App，首次进入时选择联系人并点【保存并编辑内容】。点联系人名称可以打开单聊；点联系人列表顶部【新建群聊】可以创建群聊。群聊中的角色气泡会显示发送者姓名，设置了群主、管理员或成员头衔时也会一起显示。</p>" },
        { title:"添加特殊消息", body:"<p>打开一个会话，点输入框左边的【＋】。在剧情内容面板选择图片、位置、链接、转账、红包等类型。弹窗顶部先选【发送者】并填写核心内容；说明、操作文字、读者动作等低频项目在【互动与更多设置】中。</p>" },
        { title:"添加语音或视频通话", body:"<p>添加通话事件。视频会使用联系人的「视频通话背景」。</p>" },
        { title:"编辑论坛帖子", body:"<p>正文按回车分段。发布后打开帖子并点「编辑」。帖子、主评论和楼中楼都可以设置剧情显示条件。</p>" },
        { title:"置顶、加精或排序帖子", body:"<p>轻点帖子操作按钮可置顶或加精；长按按钮后拖动可排序。</p>" },
        { title:"安排 App 阅读顺序", body:"<p>点桌面【设置】App，切到【播放顺序】，打开【阅读节奏控制】并拖动内容卡片。此处只安排阅读提示；桌面图标位置请用手机上方【排列】调整。</p>" },
        ...
        { title:"怎样切换正在编辑的角色？", body:"<p>已经完成角色接入的 App 会直接打开上次绑定的角色内容。需要编辑其他角色时，点标题栏右上角【切换】，重新选择联系人并保存。</p>" },
        { title:"删除备忘、照片或记录会立即消失吗？", body:"<p>不会。删除备忘录、浏览记录、照片、相册或购物订单时都会先显示确认弹窗；相册确认页还会说明其中照片将移到【未归类】。只有再次确认后才会修改作品。</p>" },
      ],
    })}
    ${tutorialGuide({
      category:"social",
      ...
      faq:[
        ...
        { title:"在小手机里 @ 身份", body:"<p>在文本框输入 @，再选择联系人、NPC、读者称呼或作品占位符。群聊还会提供【@全体成员】；单聊、论坛等非群聊位置不会出现这个选项。</p>" },
        { title:"让多个角色依次回复", body:"<p>先展开回复选项，再展开【角色后续】，点【添加消息】并逐条选择发送者。每条后续会先显示为顺序摘要，点摘要再编辑正文；需要修改状态、节奏或发送间隔时，继续展开该条消息的【发送设置】。</p>" },
    ...
    ${tutorialGuide({
      ...
      steps:[
        { title:"打开管理", body:"<p>互动文章：点编辑器左侧【{}】；鼠标停上去会显示【插入占位符】。小手机：点桌面【设置】App，再切到【占位符与违禁词】。</p>" },
        ...
        { title:"整理与搜索", body:"<p>搜索名称、标记、问题或违禁词；点击「整理全部词库」会处理全局与所有单项词库，按多种分隔符拆词、清除空项，并忽略大小写合并重复词。小手机中整理后仍需点【保存设置】。</p>" },
        { title:"预览测试", body:"<p>在读者预览中填写答案，检查替换范围和违禁词。</p>" },
        { title:"保存作者预设", body:"<p>常用配置可保存为作者预设。套用后会新增可独立修改的占位符副本；预设中的全局违禁词会与当前作品已有词库合并去重，不会覆盖原词。</p>" },
      ],
      ...
      faq:[
        ...
        { title:"限制部分输入", body:"<p>当前占位符的词填在「违禁词」；需要所有占位符共用的词填在「全局违禁词」。每个答案会同时检查单项和全局词库。选【包含匹配】会拦截所有含有该词的内容，选【完全匹配】则只拦截整段相同的内容。支持换行、逗号、顿号、分号、斜杠和竖线分隔。</p>" },
        { title:"带到另一篇作品", body:"<p>保存为作者预设，再到目标作品中套用。占位符会建立独立副本，预设中的全局违禁词会与目标作品现有词库合并去重。</p>" },
        { title:"内容没有替换", body:"<p>检查内容中的文字是否与标记完全一致，并确认占位符已保存到当前作品。</p>" },
        { title:"导出会带走所有作者预设吗？", body:"<p>不会。作品文件会包含当前作品正在使用的占位符、单项违禁词和全局违禁词，但不会包含浏览器里的全部作者预设。</p>" },
      ],
    })}
    ${tutorialGuide({
      category:"files",
      ...
      faq:[
        ...
        { title:"换浏览器或设备", body:"<p>在旧浏览器点「作者搬家」导出，再到新浏览器导入。</p>" },
...
const TUTORIAL_FEATURE_SECTIONS = [
  ...
  },
  {
    id:"article", title:"互动文章", features:[
      ...
      { title:"章节连续阅读、分支汇合与 NEXT", what:"控制章节内文段合并、选项后的路线汇合以及章节之间的翻页。", where:"读者端的章节正文和页面底部。", use:"普通节点末尾不设置选项时，会沿当前路线继续读取同一章节的后续节点。若节点 1 的 A、B 分别指向节点 2、3，可把无人直接指向的节点 4 排在它们之后作为汇合主线：初次打开只显示节点 1，选择 A 后显示节点 2 再接节点 4，选择 B 后显示节点 3 再接节点 4。当前章节结束后点击 NEXT。", effect:"未选择的并行分支不会提前出现；汇合节点只在当前支线走完后顺延显示。分支跳到另一章时会从新章节顶部开始阅读；NEXT 会进入下一章节，最后一章结束后显示返回首页。" },
  ...
  },
  {
    id:"interactive", title:"互动图片与 Mini文游", features:[
      ...
      { title:"设置 Mini文游占位符", what:"让读者填写姓名等内容，并替换画面里可见的文字。", where:"Mini文游专用编辑页的【占位符】卡片。", use:"点【管理占位符】，设置标记、问题和违禁词。Mini文游统一在阅读前填写；把标记直接写进画面提示、说话人、初始台词、叠加对话、热区名称与台词或画面选项文字。", effect:"读者进入作品时先填写，之后可见文字会使用读者的答案；图片、音视频链接、画面 ID 和选项目标 ID 不会替换。" },
      ...
      { title:"固定画布与三种预览", what:"让手机和电脑共用同一套构图与热区坐标。", where:"宽屏画面编辑器左侧【画布规格】，以及中间画面上方的【手机竖屏】【手机横屏】【电脑】。手机或矮屏会改为【画面】流程、【预览】构图和【设置】属性三个步骤。", use:"画布可选 9:16、16:9、3:4、1:1，或在 320 到 3840 像素范围内自定义；竖屏作品可先用推荐的 1080×1920。切换三种预览检查留白和构图；在手机或矮屏选择画面后会自动回到【预览】继续构图。", effect:"三种按钮只改变编辑器外部预览框，不会改变逻辑画布、图片位置或热区坐标，也不是完整设备模拟器；真实触发与尺寸仍要用【读者预览】在目标设备验收。" },
      ...
      { title:"多个可移动对话框", what:"在一个画面里叠放文字，制作重叠或压迫感。", where:"选中画面后打开右侧【文字】，查看【叠加对话框】。", use:"每个画面有一个主对话框；点【＋ 添加叠加对话框】可以继续添加，同一画面最多 12 个叠加对话框。选中叠加框后可修改说话人、台词、位置、宽高、字体、字号、行距、字距和透明度，也可以直接拖动或点【删除这个叠加对话框】。", effect:"有说话人或台词时，叠加框会作为该画面的静态叠加文字显示，不负责推进流程；无画面选项时点击主对话框继续，有画面选项时则选择目标画面。" },
  ...
  },
  {
    id:"phone", title:"小手机", features:[
      ...
      { title:"小手机 App 与详情返回", what:"从聊天、帖子或 App 逐层回到手机桌面。", where:"App 或聊天、帖子详情页左上角的返回箭头；也可以使用浏览器或系统返回。", use:"每次返回只退出当前一层：聊天详情回消息列表，帖子详情回论坛列表，再返回才回手机桌面；从聊天卡片进入的帖子会回到原聊天位置。", effect:"在手机内部页面时不会直接跳回书架。回到手机桌面后，再使用作品外层返回才会退出作品。" },
      { title:"小手机图片导出", what:"把当前创作库作品的小手机内容整理成适合发布的 PNG 图片。", where:"创作端首页，作品卡片依次点【更多 ▾】【导出作品】【小手机图片】。", use:"选择【默认分支】或【全部分支】，再开始导出。消息、动态、论坛、备忘录、相册、浏览记录、购物和联系人会按内容逐项截图；没有内容的 App 自动跳过，过长内容自动分页，最后统一装进 ZIP。全部分支会遍历聊天的可达回复路线，每条独立分页，合计最多 64 条；非聊天模块各导出一次。导出过程中可以取消。", effect:"图片按“作品名-模块-内容名”命名；占位符内容和主角头像会用▖▜▖▗自动打码，NPC 与角色头像保持原样。不读取读者书架、回复进度或美化设置。外链图片失效、超时或禁止跨站读取时，跳过受影响的模块并列出原因；可展开【查看未导出的项目】，已成功图片仍会打包。作品在导出期间改变或删除时，整次导出终止且不保存文件。" },
      ...
      { title:"联系人", what:"建立消息和论坛使用的人物资料，并决定读者能否主动找到这位角色。", where:"小手机桌面的【联系人】App。", use:"点【联系人】，再点底部【+ 添加联系人】。输入姓名后，在联系人卡片的【读者主动添加】选择【已在联系人中】【搜索后直接添加】【搜索后发送申请】或【不在联系人 App 出现】，最后点【保存】。发送申请时还可以设置接受、拒绝或保持申请中，以及对应提示。", effect:"其它 App 可以选择并显示这个身份。选择搜索添加后，读者端联系人 App 右上角会出现【＋】；读者可搜索联系人姓名或昵称，再直接添加或发送好友申请。结果保存在当前阅读档案中。" },
      ...
      { title:"联系人名片与读者加好友", what:"在聊天中发送联系人名片，并决定读者能否从名片直接添加联系人或发出好友申请。", where:"打开会话，点输入框左边【＋】，切到下一页，再点【联系人名片】。", use:"先选择已经建立的联系人，再选择【仅查看名片】【直接添加好友】或【发送好友申请】。直接添加可填写成功反馈；发送申请还可设置接受、拒绝或申请中，并分别填写角色反应。也可以回到【联系人】，通过【读者主动添加】开放联系人 App 右上角【＋】的搜索入口。", effect:"读者点开名片后会看到完整且可滚动的联系人详情；需要互动时，必须点【添加好友】或【发送好友申请】才会完成这条剧情动作。名片和联系人搜索共用好友关系，结果会保存在当前阅读档案中，重新进入后不会重复提交。旧作品里的名片仍按仅查看处理。" },
      { title:"单聊与群聊", what:"创建聊天会话。", where:"小手机桌面的【消息】App。", use:"点【消息】，选择联系人后点【保存并编辑内容】。点联系人名称打开单聊；点联系人列表顶部【新建群聊】创建群聊。", effect:"读者可打开完整聊天记录。" },
      { title:"消息发送者", what:"指定每条消息由读者、角色或系统发出。", where:"会话底部的发送者选择区。", use:"先选择发送者，再在同一个输入框里输入文字。选中系统时会生成居中的系统提示。", effect:"普通消息按发送者显示气泡方向、头像和身份；群聊中的角色气泡还会显示发送者姓名，以及已设置的群主、管理员或成员头衔。系统提示不显示气泡。" },
      ...
      { title:"消息编辑菜单", what:"修改消息，并安排出现方式、撤回或发送失败等聊天过程。", where:"手机或 iPad 长按消息；电脑右键消息。", use:"选择编辑、出现方式、引用、多选、撤回、发送失败、在前插入时间、在前插入消息或添加选项。群聊使用【在前插入消息】时，可先选择读者、群成员或系统作为发送人；撤回后可从同一菜单取消撤回。", effect:"发送失败时，读者会先看到消息发出，再看到它迅速消失；撤回时，原消息会替换为可点开查看原文的系统提示。" },
      ...
      { title:"消息回复选项", what:"在一条消息后加入一个或多个读者选项组，并安排角色接话。", where:"手机或 iPad 长按目标消息；电脑右键目标消息。", use:"在消息菜单点【添加选项】。先展开要编辑的选项组，填写【选项文字】和【发送内容】；需要更多分支时点【添加新选项组】。展开【图片与更多设置】可添加回复图片、沉默、结束话题、点赞数和默认回复节奏；展开【角色后续】后点【添加消息】，逐条选择发送者。展开每条后续的【发送设置】，可选择【正常发送】【发送失败】或【发送后撤回】，并设置单条节奏、出现方式和发送间隔。", effect:"没有图片时，读者选择后发送【发送内容】；设置图片后会显示图片选项，并发送同一张图片，选项文字只作说明。每条后续都会按所选角色的身份显示。沉默不会生成读者气泡，但仍会记录选择并触发后续；结束话题会先播放完角色后续，再跳过本轮剩余预设消息（包括系统消息）；进入下一轮时会按当前选择重新判断显示条件，并继续按发送间隔逐条播放。多组选项会按消息顺序出现；当前选项组还未选择或角色后续仍在播放时，后面的剧情消息（包括系统消息）会暂时隐藏，再按作者顺序逐条出现；位于当前选项前面的系统消息会保持显示。无论文字选择逐字还是整条出现，图片、系统提示和其它消息都不会越过前一条。重选前面的选项会清除它之后的角色接话和后续选择。" },
      { title:"文字消息出现方式", what:"决定一条文字气泡是逐字显示，还是整条直接显示。", where:"普通文字消息：手机或 iPad 长按，电脑右键，再点【出现方式】；回复选项里的角色后续则展开该条的【发送设置】。", use:"选择【逐字出现】或【整条出现】并保存。旧作品和没有单独设置的消息默认逐字出现。", effect:"设置只改变这一条文字的呈现方式，不改变发送间隔、输入状态或剧情顺序；选择逐字出现后，即使设备开启减少动态效果也会保留逐字播放。文字、图片、系统消息和特殊卡片始终按作者添加的原顺序逐条播放。" },
      { title:"小手机剧情显示条件", what:"让消息、论坛帖子、主评论或楼中楼在读者满足指定选择组合后才出现。", where:"消息：长按或右键气泡，点【剧情显示条件】；帖子：打开后点【编辑帖子】；评论或楼中楼：点右侧操作按钮再点【编辑】。", use:"点【设置条件】后选择消息回复。可用搜索框按选项文字、会话或联系人、轮次、原消息或稳定 ID 查找；同一组里的多个选项按【或】判断，命中任一项即可；点【添加且条件】建立下一组后，各组必须全部满足。比如第一组放“同意／沉默”，第二组放“已邀请”，表示（同意或沉默）且已邀请。点【始终显示】可清空条件。", effect:"所有条件内容都使用当前阅读档案里仍然有效的选择。条件消息进入原有播放队列，文字、图片和系统消息仍按作者顺序逐条出现；帖子解锁后像论坛刚刚更新。上一级评论未解锁时，它下面的全部楼中楼也一起隐藏。读者重选导致条件失效时，相关后续选择会回滚，内容会重新隐藏。" },
      { title:"单条消息发送间隔", what:"精确控制一个气泡要在上一条发出多久后才出现。", where:"手机或 iPad 长按任意消息；电脑右键任意消息，再点【发送间隔】。回复选项中的角色后续消息则展开该条的【发送设置】。", use:"在【发送前等待（秒）】填写 0 到 60 秒，可精确到 0.1 秒；留空沿用默认 0.8 秒。这里填写的是当前消息发送前的等待时间。", effect:"普通剧情消息和回复选项后的角色气泡都会逐条按各自间隔出现；选择沉默后出现的第一条角色消息也会使用默认 0.8 秒或该条自定义间隔。发送间隔只决定气泡何时出现，不会自动显示“正在输入”；需要输入状态时另用【回复节奏】。" },
      { title:"回复节奏", what:"控制每个读者选项之后，角色接话出现得有多快。", where:"手机或 iPad 长按拥有回复选项的消息；电脑右键该消息，再点【设置回复节奏】。回复选项编辑器中的相关设置默认折叠。", use:"展开选项组的【图片与更多设置】选择【默认回复节奏】；需要单独覆盖某条角色后续时，再展开该条的【发送设置】，选择【继承本组选项】【直接出现】【很快回复】【正在输入后回复】或【稍后回复】。", effect:"非即时节奏会先显示输入状态，再按所选等待时间展示角色后续气泡；同一分支里的不同消息可以使用不同速度。" },
      ...
      { title:"群聊身份", what:"设置群主、管理员和成员头衔。", where:"打开群聊，点右上角菜单，再点【管理群聊】。", use:"先勾选群成员；需要管理员或头衔时，展开该成员的【身份设置】。选择群主后保存。群头像在上方的折叠项中按需填写。", effect:"群聊消息旁显示对应身份。" },
      { title:"群聊 @ 全体成员", what:"在群聊消息中插入面向所有成员的提及。", where:"群聊底部消息输入框，以及群聊回复选项的【发送内容】和【角色后续】输入框。", use:"输入 @，从候选列表选择【全体成员】；也可以继续选择单个联系人、读者称呼或作品占位符。", effect:"保存后按 @全体成员 显示。这个候选项只在群聊出现，单聊和论坛不会混入。" },
      { title:"动态", what:"制作角色动态、评论和读者回复。", where:"点桌面【消息】App，再进入【动态】。", use:"先填写动态内容与发布身份；图片和时间在【发布设置】中按需添加，再继续设置评论和回复选项。", effect:"读者可以浏览动态并选择回复。" },
      { title:"论坛", what:"创建帖子和一级评论。", where:"点桌面【论坛】App，完成角色接入后进入帖子列表。", use:"点新建帖子按钮，选择发布身份并填写标题、正文。显示时间、评论数、图片和剧情显示条件在【发布设置】中按需填写，最后点【发布】。打开帖子后可继续添加评论。", effect:"读者可浏览帖子并参与评论区互动。" },
      ...
      { title:"论坛读者回复选项", what:"为指定评论准备一个或多个读者选项组。", where:"在帖子评论区轻点目标评论或楼中楼。", use:"在回复人选择器中点【读者】，再打开【编辑读者回复选项】。填写【选项文字】和【发送内容】，需要更多分支时点【添加新选项组】。回复图片与初始点赞数在【图片与更多设置】中。已设置的选项会显示在评论下方，轻点选项即可再次编辑。", effect:"文字选项会把【发送内容】回复到对应楼中楼；图片选项会回复同一张图片，选项文字只作说明。读者回复不会占用或改写一级评论楼层。" },
      { title:"论坛角色后续回复", what:"为每个读者选项安排角色继续接话。", where:"打开【编辑读者回复选项】，展开要编辑的选项，再展开【角色后续】。", use:"点【添加消息】，再按顺序点开每条摘要，逐条选择联系人、小号或 NPC，填写回复内容与初始点赞数。完成的消息会重新收成摘要，方便检查播放顺序。", effect:"角色回复会进入目标评论的楼中楼，并明确显示为回复读者；一个选项可连续显示多条后续回复。" },
      ...
      { title:"备忘录", what:"为角色添加带时间的备忘内容。", where:"点桌面【备忘录】App；首次进入时选择联系人并点【保存并编辑内容】。", use:"进入备忘录后，点标题栏右上角【+】。在下方填写备忘内容和日期时间。", effect:"读者会在该角色的备忘录中看到内容。再次进入会直达已绑定角色；可点右上角【切换】更换角色。" },
      { title:"相册", what:"按相册整理角色照片和说明。", where:"点桌面【相册】App；首次进入时选择联系人并点【保存并编辑内容】。", use:"新建照片时先填写描述或图片链接；显示时间和所属相册在【归档与显示设置】中按需填写。", effect:"读者可进入相册逐张查看。再次进入会直达已绑定角色；可点右上角【切换】更换角色。" },
      { title:"浏览记录", what:"添加角色浏览过的页面记录。", where:"点桌面【浏览器】App；首次进入时选择联系人并点【保存并编辑内容】。", use:"进入浏览记录后，点标题栏右上角【+】。填写页面标题、网址和日期时间。", effect:"读者会看到带时间的浏览历史。再次进入会直达已绑定角色；可点右上角【切换】更换角色。" },
      { title:"购物", what:"制作购物车、订单和商品记录。", where:"点桌面【购物】App；首次进入时选择联系人并点【保存并编辑内容】。", use:"点右上角【+】，先填写商品名和价格；款式、店铺、时间与图片在【更多商品设置】中。修改已有商品时，手机或 iPad 长按商品卡片，电脑右键商品卡片，再点【编辑】。", effect:"读者可查看角色的购物车和订单。再次进入会直达已绑定角色；可点右上角【切换】更换角色。" },
      { title:"内容删除与确认", what:"防止误删角色 App 中已经写好的内容。", where:"备忘录、浏览记录、相册、照片和购物订单的删除入口。", use:"第一次点删除只会打开确认弹窗；核对内容名称和影响后，再点确认删除。删除相册时，弹窗会说明相册里的照片将移到【未归类】。", effect:"取消不会修改作品；只有确认后才会删除目标内容。" },
      { title:"角色接入", what:"为不同联系人分配专属 App 内容。", where:"点桌面【消息】、【论坛】、【备忘录】、【相册】、【浏览器】或【购物】App。", use:"首次进入会打开角色接入页。选择联系人，再点【保存并编辑内容】；保存后再次进入会直接打开该角色内容，需要更换时点标题栏右上角【切换】。", effect:"每个 App 会记住当前绑定角色，并显示对应数据。" },
      { title:"阅读节奏控制", what:"安排读者查看内容的顺序。", where:"点桌面【设置】App，再切到【播放顺序】。", use:"打开开关，拖动内容卡片排序，最后点底部【保存】。基础时间设置在【基础设置】，占位符和违禁词在【占位符与违禁词】。", effect:"读者会按顺序收到浏览提示。" },
    ],
  },
  {
    id:"social", title:"人物社交", features:[
      ...
      { title:"读者回复与后续消息", what:"让读者选择文字或图片回复，并安排角色继续接话。", where:"消息、动态或论坛的回复选项编辑器。", use:"展开第一组选项并填写内容；需要更多分支时点【添加新选项组】。图片和其它低频配置在【图片与更多设置】中；需要角色接话时，再展开【角色后续】，按顺序点开每条摘要编辑。", effect:"文字选项发送【发送内容】；图片选项发送所选图片；随后按摘要顺序显示角色后续内容。" },
  ...
  },
  {
    id:"placeholders", title:"占位符", features:[
      { title:"创建占位符", what:"用读者填写的内容替换作品文字。", where:"互动文章点编辑器左侧【{}】；小手机点桌面【设置】App，再切到【占位符与违禁词】。", use:"进入管理后点【添加占位符】，填写自定义标记、显示名称和问题，再保存。", effect:"默认会在阅读前显示对应问题；互动文章也可以改为文中填写。" },
      ...
      { title:"全局违禁词", what:"让同一作品的所有占位符共用一份限制词。", where:"进入【占位符管理】，找到顶部默认折叠的【全局违禁词 · N 个】。", use:"点击标题展开，按需要填写【包含匹配】和【完全匹配】，再点【整理全部词库】。小手机还要点设置页底部【保存设置】。", effect:"每个答案会同时检查当前占位符自己的词库和作品全局词库；单项设置不会覆盖或关闭全局设置。每张占位符卡片可以展开查看继承的全局词及其匹配方式。" },
      { title:"搜索与整理词库", what:"查找占位符和清理重复词语。", where:"进入【占位符管理】，使用顶部搜索框和【整理全部词库】。", use:"在搜索框输入名称、标记、问题或违禁词；搜索命中折叠的全局或单项违禁词时，对应区域会自动展开。需要整理时点【整理全部词库】；小手机中整理后仍需点【保存设置】。", effect:"整理会处理全局和所有单项词库，拆分内容、清理空项，并按忽略大小写去重，同时保留每个词第一次出现的写法。" },
      { title:"作者占位符预设", what:"保存可跨作品复用的占位符配置。", where:"文章的【占位符管理】、小手机【设置】App，或页面顶部【?】中的【写作习惯】。", use:"在当前作品中点【保存当前为预设】。到其它作品打开【我的预设】，选择名称后点【套用预设】。", effect:"目标作品会新增一份可独立修改的占位符副本；预设中的全局违禁词会与目标作品现有词库合并去重，不会覆盖原词。" },
    ],
  },
  {
    id:"files", title:"文件与备份", features:[
      ...
      { title:"读者美化包", what:"导入已有美化包恢复读者端阅读外观。", where:"进入【读者端】，点顶部【外观】，再找到【导入美化包】。", use:"点【导入美化包】并选择旧版美化包，可恢复壁纸、字体、图标、自定义样式、个人主页顶部图和桌面组件外观。", effect:"导入只更新读者端外观，不替换昵称、头像、读者 ID、阅读记录和作品内容；组件便签也只留在本机。读者端不提供任何导出。" },
      ...
      { title:"作者搬家", what:"迁移作者创作库和写作习惯，不包含读者作品、进度或个性化数据。", where:"创作端首页【我的作品】标题下方的【作者搬家】。", use:"旧设备点【作者搬家】并导出；新设备打开同一入口并导入。旧版搬家包仍可导入恢复已有数据。", effect:"创作库和作者设置会合并到新浏览器；当前读者数据不会被新导出包带走。" },
...
const TUTORIAL_FAQ_SECTIONS = {
  ...
  interactive:[
    ...
    { question:"Mini文游最后一个画面之后会怎样？", answer:"最后一个画面没有画面选项时，读者探索完全部热区并点击主对话框后会进入作品完成页，可以选择【重新开始】或【返回书架】。如果设置了画面选项，则会先显示选项并跳到所选目标画面。Mini文游没有文章节点可继续跳转。" },
    ...
    { question:"为什么点击对话框还不能进入下一画面？", answer:"先探索当前画面的全部互动点。页面会提示还有几个位置未探索；全部完成后，无画面选项时点击主对话框进入左侧列表中的下一画面，有画面选项时改为选择目标画面。" },
    { question:"画面没有互动点时怎样进入下一张？", answer:"没有互动点的画面会直接视为探索完成。无画面选项时点击主对话框继续；有画面选项时选择目标画面。" },
  ...
  phone:[
    { question:"联系人已经建好了，还能补好友申请吗？", answer:"可以。需要让角色主动申请时，可在对应会话中添加“好友申请”剧情事件；需要让读者主动申请时，点【＋】进入第二页添加【联系人名片】，选择已有联系人，再把互动方式设为【发送好友申请】。两种方式都会把结果保存在当前阅读档案中。" },
    ...
    { question:"角色后续回复怎样分成多个气泡？", answer:"打开消息的【添加选项】，先展开要编辑的选项，再展开【角色后续】。每点一次【添加消息】就新增一个气泡；每条后续会先显示为顺序摘要，点摘要再编辑发送人和内容。消息状态、单条节奏、出现方式和发送间隔在该条的【发送设置】中。换行不会自动拆成多个气泡。" },
    { question:"读者回复选项怎样发送图片？", answer:"打开回复选项编辑器，填写【选项文字】后展开【图片与更多设置】。可以粘贴图片链接或点【选择图片】导入本地图片；本地图片会自动压缩。读者看到图片和选项说明，选择后发送同一张图片，不会再额外发送【发送内容】文字。" },
    { question:"怎样让角色先显示正在输入再回复？", answer:"手机或 iPad 长按拥有回复选项的消息，电脑右键该消息，点【设置回复节奏】。也可以展开选项组的【图片与更多设置】选择默认速度；某条角色后续需要单独覆盖时，展开它的【发送设置】并修改【单条节奏】。不需要输入状态时选【直接出现】。" },
    { question:"怎样单独设置某条消息隔多久发出？", answer:"手机或 iPad 长按任意消息，电脑右键任意消息，点【发送间隔】，填写 0 到 60 秒。回复选项中的角色后续要先展开该条的【发送设置】，再填写【发送前等待（秒）】；留空使用默认 0.8 秒，选择沉默后的第一条角色消息也一样。" },
    { question:"怎样让一条文字整条出现而不是逐字显示？", answer:"手机或 iPad 长按普通文字消息，电脑右键该消息，点【出现方式】，再选【整条出现】。回复选项里的角色后续可在每条消息的【发送设置】中单独选择。这个设置只改变文字动画；图片、系统消息和其它内容仍会按作者添加顺序逐条播放。" },
    { question:"怎样制作沉默、拒绝分支和剧情更新？", answer:"编辑消息回复选项时，展开【图片与更多设置】；勾选【沉默】可让读者不发送气泡，勾选【结束当前话题】会先播完角色接话，再跳过本轮剩余预设消息，进入下一轮时重新判断剧情显示条件。随后长按或右键后续消息设置【剧情显示条件】，或在帖子编辑器选择同一回复选项，即可让拒绝分支消息和论坛更新只在对应选择后出现。" },
    { question:"群聊怎样 @ 全体成员？", answer:"在群聊消息框输入 @，从候选列表选择【全体成员】。群聊的读者回复和角色后续消息也可以这样插入；单聊和论坛不会显示这个候选项。" },
    ...
    { question:"已经设置的论坛回复选项怎样修改？", answer:"点评论下方的选项文字，修改【选项文字】、【发送内容】或【角色后续】；回复图片和初始点赞数在【图片与更多设置】中。完成后点【保存】。" },
    { question:"读者怎样设置自己的论坛账号？", answer:"在读者端打开任意论坛帖子，点标题栏右侧的账号入口，设置昵称和头像后保存。论坛会优先使用读者本地资料；没有本地资料时才沿用作者预设。" },
    { question:"论坛评论和楼中楼怎样排序？", answer:"作者端可在评论区拖动内容调整保存顺序：手机或 iPad 长按后拖动，电脑按住鼠标拖动；一级评论会带着楼中楼一起移动。读者端帖子评论区可切换【热门】【最新】或【楼层】；【楼层】会按作者保存的一级评论顺序显示，作者自定义的楼层号仍保持不变。" },
  ...
  placeholders:[
    ...
    { question:"为什么打开占位符管理看不到违禁词输入框？", answer:"全局违禁词和每张卡片的单项违禁词默认折叠。点击全局或单项违禁词的标题行即可展开；搜索命中其中的词时也会自动展开。" },
