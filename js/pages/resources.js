  ...
  return `<div class="resource-panel" data-resource-panel="tutorial">
    ...
    ${tutorialGuide({
      ...
      steps:[
        ...
        { title:"导出和备份", body:"<p>回到首页，在作品卡片上点【更多 ▾】，再点【发送与导出】。可以调用系统分享或下载 .tuuru，也可以生成加密 PNG；之后可从首页【导出中心】查看本机导出记录。需要备份全部创作内容时，点【我的作品】标题下方的【备份全部】。</p>" },
      ],
    ...
    ${tutorialGuide({
      ...
      steps:[
        ...
        { title:"导出单篇作品", body:"<p>回到创作端首页，在作品卡片上点【更多 ▾】，再点【发送与导出】。点【发送 .tuuru】会优先调用系统分享，不支持时自动下载；也可以直接【下载 .tuuru】或【生成加密 PNG】。</p>" },
        { title:"管理导出记录", body:"<p>点首页【导出中心】，可按 .tuuru、PNG 和作品集筛选记录，查看作品导出后是否又有修改，并重新发送或生成文件。这里仅保存时间、格式和文件大小等信息，不保存作品文件，也不会上传作品内容。</p>" },
...
const TUTORIAL_FEATURE_SECTIONS = [
  ...
  },
  {
    id:"files", title:"文件与备份", features:[
      { title:"导出单篇作品", what:"生成可交给读者的作品文件。", where:"创作端首页的作品卡片。", use:"点【更多 ▾】，再点【发送与导出】，然后选择【发送 .tuuru】、【下载 .tuuru】或【生成加密 PNG】。", effect:"支持系统文件分享时会打开系统分享面板；不支持时会自动下载，读者端均可导入阅读。" },
      { title:"导出中心", what:"查看和管理当前浏览器里的导出记录。", where:"创作端首页顶部【导出中心】；移动端也可从【管理作品库】进入。", use:"按格式筛选，查看【当前版本】或【作品已在导出后修改】，并按需重新发送、下载或生成。也可以移除单条记录或清空全部记录。", effect:"只记录导出时间、格式、大小和状态，不保存作品文件，也不会把内容上传到服务器。" },
...
const TUTORIAL_FAQ_SECTIONS = {
  ...
  interactive:[
    ...
    { question:"普通互动和剧情选项支持占位符吗？", answer:"支持。普通互动标题、选项文本、选择后内容，以及节点末尾的剧情分支文字都会替换为读者填写的值。" },
