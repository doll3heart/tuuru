...
const TUTORIAL_FEATURE_SECTIONS = [
  ...
  },
  {
    id:"phone", title:"小手机", features:[
      ...
      { title:"消息回复选项", what:"在一条消息后加入读者选择和角色接话。", where:"手机或 iPad 长按目标消息；电脑右键目标消息。", use:"在消息菜单点【添加选项】。填写选项文本和读者回复；在【角色后续消息】中逐条点【添加】，选择接话的群成员并填写内容。每条后续消息都能选择【正常发送】【发送失败】或【发送后撤回】，也能单独设置节奏。多条消息都设置了选项时，读者会按消息顺序逐组选择。", effect:"每条后续消息都会按所选群成员的身份显示。当前一组还未选择时，后面的消息会暂时隐藏；重选前面的选项会清除这次选择之后的角色接话和后续选择，再从该处继续。" },
