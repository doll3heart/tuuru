...
const TUTORIAL_FEATURE_SECTIONS = [
  ...
  },
  {
    id:"phone", title:"小手机", features:[
      ...
      { title:"消息回复选项", what:"在一条消息后加入读者选择和角色接话。", where:"手机或 iPad 长按目标消息；电脑右键目标消息。", use:"在消息菜单点【添加选项】。填写选项文本和读者回复；在【角色后续消息】中逐条点【添加】，选择接话的群成员并填写内容。还可以为每组选项设置回复节奏。多条消息都设置了选项时，读者会按消息顺序逐组选择。", effect:"每条后续消息都会按所选群成员的身份显示；每组选择只属于对应消息，互不覆盖。" },
