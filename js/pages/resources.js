...
const TUTORIAL_FEATURE_SECTIONS = [
  ...
  },
  {
    id:"phone", title:"小手机", features:[
      ...
      { title:"小手机图片导出", what:"把当前作品的小手机内容批量整理成适合发布的 PNG 图片。", where:"进入【读者端】，切换顶部“美化”页，在手机预览上方找到【图片导出】。", use:"点【图片导出】，再点【导出全部内容】并等待下载。消息、动态、论坛、备忘录、相册、浏览记录、购物和联系人会按已有内容逐项截图；没有内容的 App 自动跳过，过长内容自动分页，最后统一装进 ZIP。导出过程中可以取消。", effect:"图片按“作品名-模块-内容名”命名；读者填写的占位符内容和读者本人头像会用▖▜▖▗自动打码，NPC 与角色头像保持原样。外链图片若禁止跨站读取，对应位置可能显示为空白；某项失败时可展开【查看未导出的项目】，已成功图片仍会打包。" },
