  ...
  return `<div class="resource-panel" data-resource-panel="tutorial">
    ...
    ${tutorialGuide({
      ...
      steps:[
        ...
        { title:"添加读者回复选项", body:"<p>打开会话后，长按或右键目标消息，点【添加选项】。填写【选项文字】和【发送内容】；需要更多分支时点【添加新选项组】。图片、沉默、结束话题和默认节奏都在【图片与更多设置】中。</p>" },
    ...
    ${tutorialGuide({
      ...
      faq:[
        ...
        { title:"让多个角色依次回复", body:"<p>在回复选项的【角色后续】中点【添加消息】，逐条选择发送者。需要修改状态、节奏或发送间隔时，展开该条消息的【发送设置】。</p>" },
...
const TUTORIAL_FEATURE_SECTIONS = [
  ...
  },
  {
    id:"phone", title:"小手机", features:[
      ...
      { title:"论坛角色后续回复", what:"为每个读者选项安排角色继续接话。", where:"打开【编辑读者回复选项】，找到【角色后续】。", use:"点【添加消息】，逐条选择联系人、小号或 NPC，填写回复内容与初始点赞数。", effect:"角色回复会进入目标评论的楼中楼，并明确显示为回复读者；一个选项可连续显示多条后续回复。" },
      ...
      { title:"相册", what:"按相册整理角色照片和说明。", where:"点桌面【相册】App；首次进入时选择联系人并点【保存并编辑内容】。", use:"先新建相册，再打开相册添加图片、说明和时间。", effect:"读者可进入相册逐张查看。再次进入会直达已绑定角色；可点右上角【切换】更换角色。" },
      ...
      { title:"购物", what:"制作购物车、订单和商品记录。", where:"点桌面【购物】App；首次进入时选择联系人并点【保存并编辑内容】。", use:"点右上角【+】添加商品。修改已有商品时，手机或 iPad 长按商品卡片，电脑右键商品卡片，再点【编辑】。", effect:"读者可查看角色的购物车和订单。再次进入会直达已绑定角色；可点右上角【切换】更换角色。" },
  ...
  },
  {
    id:"social", title:"人物社交", features:[
      ...
      { title:"读者回复与后续消息", what:"让读者选择文字或图片回复，并安排角色继续接话。", where:"消息、动态或论坛的回复选项编辑器。", use:"填写第一组选项；需要更多分支时点【添加新选项组】。图片和其它低频配置在【图片与更多设置】中，角色接话在【角色后续】中逐条添加。", effect:"文字选项发送【发送内容】；图片选项发送所选图片；随后按顺序显示角色后续内容。" },
...
const TUTORIAL_FAQ_SECTIONS = {
  ...
  phone:[
    ...
    { question:"角色后续回复怎样分成多个气泡？", answer:"打开消息的【添加选项】，在【角色后续】中每点一次【添加消息】就新增一个气泡；逐条选择发送人并填写内容。消息状态、单条节奏、出现方式和发送间隔在该条的【发送设置】中。换行不会自动拆成多个气泡。" },
